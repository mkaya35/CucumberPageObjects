...
@CucumberOptions(features = "src/test/resources/features", 
		...
		tags= {"@Used-Search-Cars,@Search-Cars"},
		plugin = { "pretty", "json:target/Runcuke/cucumber.json","html:target/Runcuke/cucumber.html", "com.cucumber.listener.ExtentCucumberFormatter" })
